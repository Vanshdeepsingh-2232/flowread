...
const Library: React.FC<LibraryProps> = ({ onSelectBook, onUploadFile, onOpenSidebar, processingState }) => {
  ...
  return (
    <div className="min-h-screen bg-background p-6 md:p-10 max-w-5xl mx-auto transition-colors duration-300">
